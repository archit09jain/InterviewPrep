  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="#tour">Contests</a></li>
        <li><a href="#contact">Gym</a></li>
        <li><a href="#contact"><span class="glyphicon glyphicon-user"></span>Login</a></li>
...
<div id="band" class="container text-center">
  ...
  <p><em>Code Eat Sleep & Learn!</em></p>
  <p>
    ...
    We will help you prepare for the coding interviews and their written test. It's a platform for aspiring programmers
