         ...
         var xhttp = new XMLHttpRequest();
          xhttp.onreadystatechange = function() {
            if (xhttp.readyState == 4 && xhttp.status == 200) {
              var store = xhttp.responseText;
            }
          };
          xhttp.open("GET", "index.php?email="+email+"&password="+password, true);
          xhttp.send();
      }
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form role="form" >
                  ...
                  <button type="submit" onclick ="updateDb()" class="btn btn-primary">Submit</button>
                  <a onclick="login()" class="btn btn-primary facebook"> <i class="fa fa-facebook modal-icons"></i> Login With Facebook </a>
                </form>
...
<div class="jumbotron text-center">
  <h1>InterviewPrep</h1> 
  <p>Programming Interviews Made Easy</p> 
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      <h2>About</h2><br>
      <h4>Learn and Practice on almost all coding interview questions asked historically and get referred to the best tech companies.</h4><br>
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-phone"></span>+9582910353</p>
      <p><span class="glyphicon glyphicon-envelope"></span> archit.dtu.jain@gmail.com</p>    
    </div>
...
<script>
var myCenter = new google.maps.LatLng(28.7500796,77.1154765);
